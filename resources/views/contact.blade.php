                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7 col-xl-6">
                        <div class="store-content">
                          <h3 class="store-title">Asiano's Arts and Crafts</h3>
                          <!-- End .store-title -->
                          <address>Rizal Avenue, Baranggay San Miguel, Puerto Princesa City</address>
                          <div><a href="tel:#">09467293562</a></div>
