  ...
  <div class="page-wrapper">
          ...
          <div class="header-left">
            ...
            <nav class="main-nav">
              <ul class="menu sf-arrows">
                ...
                <li>
                  <a href="category-fullwidth.html" class="sf-with-ul">Shop</a>
    ...
    <main class="main">
      <div
        ...
        style="background-image: url('{{ asset("customer/images/page-header-bg.jpg") }}');">
        <div class="container">
          ...
          <main>
            <section class="announcements">
              ...
              <div class="announcement-list">
                ...
                <a href="announcement-detail1.html" class="announcement-link">
                  <div class="announcement new-arrivals">
                    <div class="date">Today 03:00</div>
                    <h3>NEW ARRIVAL!</h3>
                    <p>
                      Dear Phemex Traders, The day has finally come! Today, we have
                      officially launched our Membership Spot Trading services...
                    </p>
                  </div>
                </a>
                <!-- end announcement here -->

                <!-- start announcement here -->
                <a href="announcement-detail2.html" class="announcement-link">
                  <div class="announcement events">
                    <div class="date">Today 03:00</div>
                    <h3>Exhibition</h3>
                    <p>
                      Dear Phemex Traders, The day has finally come! Today, we have
                ...
                <!-- start announcement here -->
                <a href="announcement-detail3.html" class="announcement-link">
                  <div class="announcement new-arrivals">
                    <div class="date">Today 03:00</div>
              ...
              <!-- start announcement here -->
              <a href="announcement-detail4.html" class="announcement-link">
                <div class="announcement new-arrivals">
                  <div class="date">Today 03:00</div>
                  <h3>New Items Soon!</h3>
                  <p>
  ...
  <div class="mobile-menu-wrapper">
    ...
    <nav class="mobile-nav">
      <ul class="mobile-menu">
        ...
        <li> <a href="elements-list.html">Elements</a> </li> <!-- Closing </li> added here -->
      </ul>
    </nav>
    <!-- End .mobile-nav -->
