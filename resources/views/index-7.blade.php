...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('customer/images/icons/favicon.icon') }}">
    ...
    <link rel="stylesheet" href="{{ asset('customer/css/skins/skin-demo-7.css') }}">
    <link rel="stylesheet" href="{{ asset('customer/css/demos/demo-7.css') }}">
</head>
                ...
                <div class="container-fluid">
                    <div class="header-left">
                        ...
                        <a href="index.html" class="logo">
                            <img src="{{ asset('customer/images/demos/demo-7/logo.png') }}" alt="Molla Logo" width="105" height="25">
                        </a>
                                    ...
                                    <div class="megamenu demo">
                                        <div class="menu-col">
                                            ...
                                            <div class="demo-list">
                                                <div class="demo-item">
                                                    <a href="index-1.html"> 
                                                        <span class="demo-bg" style="background-image: url('{{ asset("customer/images/menu/demos/1.jpg") }}');"></span>
